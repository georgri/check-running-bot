...
FULL_CHECK_URL=https://runc.run/check-in/217/
FULL_SOLD_OUT_MARKER="Свободные места на 42,2 км закончились"
FULL_BOOKING_DISTANCE_LABELS=42,2 км|42.2 км|42 км
HALF_CHECK_URL=https://runc.run/check-in/228/
HALF_SOLD_OUT_MARKER="Свободные места на 21,1 км закончились"
HALF_BOOKING_DISTANCE_LABELS=21,1 км|21.1 км|21 км
BOOKING_PRIMARY_MARATHON_PACE_LABEL=3:31-3:45
BOOKING_PRIMARY_FULL_PACE_LABELS=
BOOKING_PRIMARY_HALF_PACE_LABELS=
BOOKING_SECONDARY_USERNAME=
BOOKING_SECONDARY_PASSWORD=
BOOKING_SECONDARY_MARATHON_PACE_LABEL=3:56-4:05
BOOKING_SECONDARY_FULL_PACE_LABELS=
BOOKING_SECONDARY_HALF_PACE_LABELS=
PACE_INFERENCE_SECONDS_FASTER=10
CHECK_MAX_RETRIES=3
